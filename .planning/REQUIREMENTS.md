...
- [x] **INFRA-03**: A programmatic fixture generator script (`tests/fixtures/generate.ts`) creates verified `.xlsx` test files via SheetJS
- [x] **INFRA-04**: Test fixtures cover: simple cross-sheet refs, external file refs, named ranges, empty workbook, malformed/corrupt file, large workbook (100+ sheets), circular references
