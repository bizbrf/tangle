...
docs/
  ...
  system-design-review.md       # Design review and improvement roadmap
.github/
  workflows/
    ci.yml                      # Build, lint, test — runs on all PRs and pushes
    deploy.yml                  # GitHub Pages + Tauri build — runs on main after CI
```
...
For improvement ideas and the refactoring roadmap, see [docs/system-design-review.md](docs/system-design-review.md).
